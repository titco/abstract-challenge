...
##Result
```{r}
TAFT_2736 <- read.csv("C:/Users/Welcome/Documents/TAFT_2736.csv")
...
```
##Conclusion
Total number of available patients for analysis is 1154. By analysis in R I findout that total 21 patient having abdominal trauma in this data set. ICD code "S31", "S32", "S320", "S39" is found only here using for abdominal trauma So the percentage is 0.17, 0.08, 1.12, 0.43. So It is conclude that very less number of patients having avdominal trauma in this dataset.