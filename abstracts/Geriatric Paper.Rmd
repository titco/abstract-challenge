...
##SBP
dt$sbp_cat <- ifelse(dt$sbp_1 <90, "<90", ">=90")
...
View(table(dt$tos,dt$surgery_type))
View(table(dt$surgery_type,dt$tos))
...
myvars <- c("sex", "tran", "moi", "moi_collapsed","mot", "ti", "sbp_1","sbp_cat", "gcs_t_1" , "gcs_cat" ,  "ct", "fast", "xray","tbi3", "iss" , "iss_cat", "surg", "surgery_type", "hd")
catvars <- c("sex", "tran", "moi", "moi_collapsed","mot", "ti", "sbp_cat", "gcs_cat", "ct", "fast", "xray","tbi3", "iss_cat" , "surgery_type", "surg", "hd")
