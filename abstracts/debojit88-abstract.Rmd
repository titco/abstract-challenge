...
>>>>>>> 6fcd1c7... Clean files, remove old versions
...
delay_hours <-as.numeric(difftime(date.time.arrival, date.time.injury, units = "hours"))
...
## I suggest you don't do this twice, change the code above instead to
## have multiple categories of Transport accidents
icd.ranges <- list(c("Transport accident" = get_icd_range("V", 0, 99)),
...
# Analysis
```{r}
## Not sure what's going on down here but. If you want to keep it then
## I suggest you incorporate it into the code above
