...
myvars <- c("age", "agegrp", "sex", "tyi", "mot",
"tran", "avpu", "sbp", "dbp", "hr", "spo2", "vo2", "rr", "nsi", "hd", "moi.collapsed", "isspv", "rts")

catvars <- c("sex", "moi.collapsed", "tyi", "mot", "tran", "avpu", "vo2", "nsi", "hd","gcs",  "valid", "rts")

CreateTableOne(vars = myvars, data=kbbh, factorVars = catvars, showAllLevels = TRUE)
