...
grid.newpage()
one <- boxGrob("Total patients in TTRIS dataset n=15000",
               x=0.5,y=0.5)
two <- boxGrob("Patients in each centre n=5200")
three <- boxGrob("Patients in KBBH data of TTRIS n=4793")
six <- boxGrob("Study population : Patients Triaged green in KBBH dataset n=4133")
four <- boxGrob("Excluded : Records with incomplete observations n=227")
five <- boxGrob("Excluded : Patients that did not consent for follow-up n=414")
