...
Table1 shows Characteristics of the patient injury were most commonly `r inj1` (`r p_supf`%), followed by `r inj2` (`r p_ndi`%), `r inj3` (`r p_ow`%) and `r inj4` (`r p_frac`%). As per the Injury Severity Score (ISS) 50.2% of the patients had minor injuries and 49.4% patients had no defined injuries, the reamining 0.4% patients were classified into patients with moderately injuries. 
...
chisq.test(kbbh$agegrp,kbbh$inj_type)
