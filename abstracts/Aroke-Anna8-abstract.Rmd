...
merged <- merge(g, h, by = "pid") # When you do this you loose all extra patients present in g mot not in h. Is that intentional? I had tried merging h to g by pid too.. I still lost 10 records. So I thought maybe the pids are no longer in the dataset
...
# Mode of Transport
nm_pvt <- sum(kbbh$mot == 2)
percent_mot_pvt <- round(mean(kbbh$mot == 2) * 100,2)
...
## Have used column numbers here since checking most common
moi1 <- sorted_moi[[1]][]
moi2 <- sorted_moi[[2]][]
moi3 <- sorted_moi[[3]][]
...
"tran", "avpu", "sbp", "dbp", "hr", "spo2", "vo2", "rr", "nsi", "hd", "gcs",  "valid", "isspv", "rts")

catvars <- c("sex", "moi.collapsed", "tyi", "mot", "tran", "avpu", "vo2", "nsi", "hd", "gcs",  "valid", "rts")
