...
calculate_n_p <- function(level.name, factor.var){
    ...
    list.sort(return.list, nm, decreasing = TRUE) ## Trying to not use the sort_most_common function seperately. It works when I run in on moi.data.. But not in the function.
}
...
list.sort(moi.data, nm, decreasing = TRUE)
