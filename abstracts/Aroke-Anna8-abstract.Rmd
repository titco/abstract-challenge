...
Emergency departments are perceived to provide quick and easy access to healthcare, leading to visits of patients with no injury or minor injuries.[@Uscher-Pines2013][@Coster2017]
...
d <- chisq.test(kbbh$inj_arr,kbbh$inj_type)
