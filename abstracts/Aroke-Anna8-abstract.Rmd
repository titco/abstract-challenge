...
grViz("digraph flowchart {
      ...
      tab4 [label = 'Excluded : \n Records with incomplete observations n=227 \n Patients that did not consent for follow-up n=414']
      tab5 [label = 'Included: n=4152']
      tab6 [label = 'Patients Triaged green in KBBH dataset n=4133', shape = oval]
