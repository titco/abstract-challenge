...
Emergency departments provide quick and easy access to healthcare, leading to visits of patients with no injury or minor injuries.[@Uscher-Pines2013]
...
Severity of Injury was assesed using ISS and RTS scores[@champion1989]
...
The Injury Severity Score (ISS) indicated that 50.2% were 'mild', 49.4% patients had 'No defined injuries', the reamining 0.4% patients had 'moderate' severity. 
...
table(kbbh$ardd, kbbh$inj_type)

table(kbbh$inj_type == "Amputation", kbbh$iopinj6icd)
