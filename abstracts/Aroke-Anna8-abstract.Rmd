...
myvars <- c("age", "tyi", "mot", "tran", "avpu", "sbp", "dbp", "hr", "spo2", "vo2", "rr", "nsi", "hd", "gcs","gcs.cat", "isspv", "rts","inj_type")

catvars <- c("tyi", "mot", "tran", "avpu", "vo2", "nsi", "hd","gcs.cat", "inj_type")
...
```{r}
Table2 <- round(xtabs(~kbbh$isspv+kbbh$moi.collapsed, data = kbbh),0)
kable(Table2,
      caption = "Percentage distribution of Injury severity among different Mechanism of Injury",
      )

Table2 <- round(rowPerc(xtabs(~kbbh$isspv+kbbh$moi.collapsed, data = kbbh)),0)
kable(Table2,
      caption = "Percentage distribution of Injury severity among different Mechanism of Injury",
      )
```
