...
## Rearranging columns
dt <- dt[,c(17,1,20,18:19,21:33,36:45,47,46,34:35,48:129,142,2:15,130:141)]

## Adding the extra columns to g
extra_col <- dt[,130:141]
...
dt[,22:68] <- dt[,22:68] %>% 
    mutate_all(funs(str_replace(., "999", 'NA')))
