...
lapply(c("age","sex","moi_collapsed","prehop_delay","rr_1","sbp_1","gcs_t_1","surg","lohps","licu","tbi"),
       function(var) {
...
m1 <- glm(died~age+sex+moi_collapsed+prehop_delay+rr_1+sbp_1+gcs_t_1+lohps+surg+licu+tbi, data = iss_9,  family = binomial(link = "logit"))
summ(m1, exp = T)
tbl_regression(m1, exponentiate = TRUE)

iss_16 <- subset(dt, dt$iss == 16)

Table3 <- CreateTableOne(vars = myvars, strata = "tbi", data= iss_16, factorVars = catvars)
knitr::kable(print(Table3,
                   caption = "Table 3. Demographic, Physiological parameters, Injury Characteristics", showAllLevels = TRUE, printToggle = FALSE, varLabels = TRUE))
...
Table3 <- CreateTableOne(vars = myvars, strata = "tbi", data= iss_25, factorVars = catvars)
knitr::kable(print(Table3,
                   caption = "Table 3. Demographic, Physiological parameters, Injury Characteristics", showAllLevels = TRUE, printToggle = FALSE, varLabels = TRUE))
